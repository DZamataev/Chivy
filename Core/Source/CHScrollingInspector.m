...
{
    return [CHScrollingInspector frameValueForKey:_targetFramePropertyKeyPath fromObject:_targetObject];
}

- (void)setTargetValueForKeypathWithNewValue:(CGFloat)newValue
{
    [CHScrollingInspector setFrameValue:newValue forKey:_targetFramePropertyKeyPath forObject:_targetObject];
}
